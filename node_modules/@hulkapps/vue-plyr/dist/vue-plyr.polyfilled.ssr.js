...
};var Object$1 = global_1$1.Object;
...
var indexedObject$1 = fails$1(function () {
  ...
  return classofRaw$1(it) == 'String' ? split$1(it, '') : Object$1(it);
} : Object$1;var TypeError$1 = global_1$1.TypeError; // `RequireObjectCoercible` abstract operation
...
var engineV8Version$1 = version$1;/* eslint-disable es/no-symbol -- required for testing */
...
var useSymbolAsUid$1 = nativeSymbol$1 && !Symbol.sham && typeof Symbol.iterator == 'symbol';var Object$2 = global_1$1.Object;
var isSymbol$1 = useSymbolAsUid$1 ? function (it) {
  return typeof it == 'symbol';
} : function (it) {
  var $Symbol = getBuiltIn$1('Symbol');
  return isCallable($Symbol) && objectIsPrototypeOf($Symbol.prototype, Object$2(it));
};var String$1 = global_1$1.String;
...
};var TypeError$2 = global_1$1.TypeError; // `Assert: IsCallable(argument) is true`
...
};var TypeError$3 = global_1$1.TypeError; // `OrdinaryToPrimitive` abstract operation
...
});var Object$3 = global_1$1.Object; // `ToObject` abstract operation
...
var TypeError$5 = global_1$1.TypeError; // `Assert: Type(argument) is Object`

var anObject$1 = function (argument) {
  if (isObject$1(argument)) return argument;
  throw TypeError$5(String$2(argument) + ' is not an object');
};var TypeError$6 = global_1$1.TypeError; // eslint-disable-next-line es/no-object-defineproperty -- safe
...
var CONFIGURABLE = EXISTS$2 && (!descriptors$1 || descriptors$1 && getDescriptor(FunctionPrototype$2, 'name').configurable);
var functionName = {
  EXISTS: EXISTS$2,
  PROPER: PROPER,
...
var call$2 = FunctionPrototype$3.call; // eslint-disable-next-line es/no-reflect -- safe
...
var Object$4 = global_1$1.Object; // ES3 wrong here
...
};var arraySlice = functionUncurryThis([].slice);/* eslint-disable es/no-object-getownpropertynames -- safe */
...
var getWindowNames$1 = function (it) {
  try {
    ...
    return arraySlice(windowNames$1);
  }
}; // fallback for IE11 buggy Object.getOwnPropertyNames with iframe and window
...
var setToStringTag$1 = function (it, TAG, STATIC) {
  if (it && !hasOwnProperty_1(it = STATIC ? it : it.prototype, TO_STRING_TAG$3)) {
    defineProperty$6(it, TO_STRING_TAG$3, {
      configurable: true,
      value: TAG
    });
  }
...
var Array$1 = global_1$1.Array; // a part of `ArraySpeciesCreate` abstract operation
...
_export$1({
  ...
  keyFor: function keyFor(sym) {
    if (!isSymbol$1(sym)) throw TypeError$8(sym + ' is not a symbol');
...
hiddenKeys$2[HIDDEN$1] = true;var defineProperty$7 = objectDefineProperty$1.f;
var NativeSymbol = global_1$1.Symbol;
var SymbolPrototype$1 = NativeSymbol && NativeSymbol.prototype;

if (descriptors$1 && isCallable(NativeSymbol) && (!('description' in SymbolPrototype$1) || // Safari 12 bug
NativeSymbol().description !== undefined)) {
  var EmptyStringDescriptionStore = {}; // wrap Symbol constructor for correct work with undefined description

  var SymbolWrapper = function Symbol() {
    var description = arguments.length < 1 || arguments[0] === undefined ? undefined : toString_1(arguments[0]);
    var result = objectIsPrototypeOf(SymbolPrototype$1, this) ? new NativeSymbol(description) // in Edge 13, String(Symbol(undefined)) === 'Symbol(undefined)'
...
var TypeError$9 = global_1$1.TypeError; // We can't use this feature detection in V8 since it causes
// deoptimization and serious performance degradation
...
};var TypeError$a = global_1$1.TypeError;
...
};var Array$2 = global_1$1.Array; // `Array.from` method implementation
...
});var TypeError$b = global_1$1.TypeError; // `Array.prototype.{ reduce, reduceRight }` methods implementation
...
var TypeError$c = global_1$1.TypeError;
var max$3 = Math.max;
var min$5 = Math.min;
...
var functionToString$2 = functionUncurryThis(FunctionPrototype$4.toString);
...
if (descriptors$1 && !FUNCTION_NAME_EXISTS) {
  defineProperty$8(FunctionPrototype$4, NAME$1, {
    configurable: true,
    get: function () {
      try {
        return regExpExec(nameRE$1, functionToString$2(this))[1];
      } catch (error) {
        return '';
      }
    }
...
});var String$4 = global_1$1.String;
var TypeError$d = global_1$1.TypeError;
...
var TypeError$e = global_1$1.TypeError;
...
var toNumber = function (argument) {
  ...
  if (isSymbol$1(it)) throw TypeError$e('Cannot convert a Symbol value to a number');
...
if (isForced_1$1(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'))) {
  ...
  'fromString,range').split(','), j = 0, key; keys$2.length > j; j++) {
    if (hasOwnProperty_1(NativeNumber, key = keys$2[j]) && !hasOwnProperty_1(NumberWrapper, key)) {
      defineProperty$9(NumberWrapper, key, getOwnPropertyDescriptor$4(NativeNumber, key));
    }
  }
...
});var RangeError$1 = global_1$1.RangeError; // `String.prototype.repeat` method implementation
...
var stringRepeat = function repeat(count) {
  ...
  return result;
};var RangeError$2 = global_1$1.RangeError;
var String$5 = global_1$1.String;
...
var Object$5 = global_1$1.Object;
var ObjectPrototype$2 = Object$5.prototype; // `Object.getPrototypeOf` method
...
var BASE_FORCED = descriptors$1 && (!CORRECT_NEW || UNSUPPORTED_Y$1 || regexpUnsupportedDotAll || regexpUnsupportedNcg || fails$1(function () {
...
}var TypeError$f = global_1$1.TypeError;
...
var createMethod$7 = function (CONVERT_TO_STRING) {
  return function ($this, pos) {
    ...
    return first < 0xD800 || first > 0xDBFF || position + 1 === size || (second = charCodeAt$1(S, position + 1)) < 0xDC00 || second > 0xDFFF ? CONVERT_TO_STRING ? charAt$2(S, position) : first : CONVERT_TO_STRING ? stringSlice$5(S, position, position + 2) : (first - 0xD800 << 10) + (second - 0xDC00) + 0x10000;
  };
};
...
if (!isCallable(IteratorPrototype[ITERATOR$3])) {
  redefine$1(IteratorPrototype, ITERATOR$3, function () {
    return this;
  });
}
...
var defineIterator = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
    ...
    if (CurrentIteratorPrototype !== Object.prototype && CurrentIteratorPrototype.next) {
      if ( objectGetPrototypeOf(CurrentIteratorPrototype) !== IteratorPrototype$2) {
        if (objectSetPrototypeOf) {
          ...
          redefine$1(CurrentIteratorPrototype, ITERATOR$4, returnThis$1);
        }
  ...
  if ( IterablePrototype[ITERATOR$4] !== defaultIterator) {
    redefine$1(IterablePrototype, ITERATOR$4, defaultIterator, {
      name: DEFAULT
    });
  }
...
};var TypeError$g = global_1$1.TypeError; // `RegExpExec` abstract operation
...
});var TypeError$h = global_1$1.TypeError; // `Assert: IsConstructor(argument) is true`
    ...
    internalSplit = function (separator, limit) {
      ...
      while (match = functionCall(regexpExec, separatorCopy, string)) {
        ...
        if (lastIndex > lastLastIndex) {
          push$6(output, stringSlice$8(string, lastLastIndex, match.index));
      ...
      } else push$6(output, stringSlice$8(string, lastLastIndex));
...
}, !SPLIT_WORKS_WITH_OVERWRITTEN_EXEC, UNSUPPORTED_Y$3);var getOwnPropertyDescriptor$5 = objectGetOwnPropertyDescriptor$1.f; // eslint-disable-next-line es/no-string-prototype-startswith -- safe
...
_export$1({
  ...
  /* , position = 0 */
    ...
    return un$StartsWith ? un$StartsWith(that, search, index) : stringSlice$9(that, index, index + search.length) === search;
  }
...
});var TypeError$i = global_1$1.TypeError;
...
var iterate = function (iterable, unboundFunction, options) {
  ...
  return new Result(false);
};var TypeError$j = global_1$1.TypeError;
...
handlePrototype(domTokenListPrototype);var ARRAY_ITERATOR = 'Array Iterator';
...
var RangeError$3 = global_1$1.RangeError;
...
var RegExp$1 = global_1$1.RegExp;
var TypeError$k = global_1$1.TypeError;
var decodeURIComponent$1 = global_1$1.decodeURIComponent;
    ...
    if (isObject$1(init)) {
      ...
      if (iteratorMethod) {
        ...
        while (!(step = functionCall(next, iterator)).done) {
          ...
          if ((first = functionCall(entryNext, entryIterator)).done || (second = functionCall(entryNext, entryIterator)).done || !functionCall(entryNext, entryIterator).done) throw TypeError$k('Expected sequence with length 2');
          push$8(entries, {
            key: toString_1(first.value),
            value: toString_1(second.value)
          });
        }
      } else for (key in init) if (hasOwnProperty_1(init, key)) push$8(entries, {
        key: key,
        value: toString_1(init[key])
      });
    } else {
      parseSearchParams(entries, typeof init == 'string' ? charAt$6(init, 0) === '?' ? stringSlice$a(init, 1) : init : toString_1(init));
    }
  }
};
...
redefine$1(URLSearchParamsPrototype, ITERATOR$7, URLSearchParamsPrototype.entries, {
  name: 'entries'
...
var TypeError$l = global_1$1.TypeError;
...
var isWindowsDriveLetter = function (string, normalized) {
  var second;
  return string.length == 2 && exec$4(ALPHA, charAt$7(string, 0)) && ((second = charAt$7(string, 1)) == ':' || !normalized && second == '|');
};

var startsWithWindowsDriveLetter = function (string) {
  var third;
  return string.length > 1 && isWindowsDriveLetter(stringSlice$b(string, 0, 2)) && (string.length == 2 || (third = charAt$7(string, 2)) === '/' || third === '\\' || third === '?' || third === '#');
};
...
/* , base */
  ...
  if (base !== undefined) {
    try {
      ...
      if (failure) throw TypeError$l(failure);
    }
  }
...
var getPathname = function () {
  var url = getInternalURLState(this);
  var path = url.path;
  return url.cannotBeABaseURL ? path[0] : path.length ? '/' + join$2(path, '/') : '';
};
  ...
  objectDefineProperties$1(URLPrototype, {
    ...
    search: accessorDescriptor(getSearch, function (search) {
      ...
      if (search == '') {
        ...
        if ('?' == charAt$7(search, 0)) search = stringSlice$b(search, 1);
        url.query = '';
    ...
    hash: accessorDescriptor(getHash, function (hash) {
      ...
      if ('#' == charAt$7(hash, 0)) hash = stringSlice$b(hash, 1);
      url.fragment = '';
...
if (NativeURL) {
  ...
  if (nativeCreateObjectURL) redefine$1(URLConstructor, 'createObjectURL', functionBindContext$1(nativeCreateObjectURL, NativeURL)); // `URL.revokeObjectURL` method
  // https://developer.mozilla.org/en-US/docs/Web/API/URL/revokeObjectURL

  if (nativeRevokeObjectURL) redefine$1(URLConstructor, 'revokeObjectURL', functionBindContext$1(nativeRevokeObjectURL, NativeURL));
}
...
NativeSymbol$1().description !== undefined)) {
  ...
  var symbolPrototype = SymbolWrapper$1.prototype = NativeSymbol$1.prototype;
  symbolPrototype.constructor = SymbolWrapper$1;
  var symbolToString$1 = symbolPrototype.toString;
  var native = String(NativeSymbol$1('test')) == 'Symbol(test)';
  var regexp$1 = /^Symbol\((.*)\)[^)]+$/;
  defineProperty$c(symbolPrototype, 'description', {
    ...
    get: function description() {
      ...
      var desc = native ? string.slice(7, -1) : string.replace(regexp$1, '$1');
      return desc === '' ? undefined : desc;
    }
  });
  _export({
...
defineWellKnownSymbol('replace');var createMethod$8 = function (IS_RIGHT) {
  return function (that, callbackfn, argumentsLength, memo) {
...
var STRICT_METHOD$9 = arrayMethodIsStrict('reduce');
...
_export({
  target: 'Array',
  proto: true,
  forced: !STRICT_METHOD$9 || !USES_TO_LENGTH$3
}, {
  reduce: function reduce(callbackfn
  /* , initialValue */
  ) {
...
}() : undefined);var inheritIfRequired$1 = function ($this, dummy, Wrapper) {
  var NewTarget, NewTargetPrototype;
  if ( // it can work only with native `setPrototypeOf`
  objectSetPrototypeOf$1 && // we haven't completely correct pre-ES6 way for getting `new.target`, so use this
  typeof (NewTarget = dummy.constructor) == 'function' && NewTarget !== Wrapper && isObject(NewTargetPrototype = NewTarget.prototype) && NewTargetPrototype !== Wrapper.prototype) objectSetPrototypeOf$1($this, NewTargetPrototype);
  return $this;
};var MATCH$3 = wellKnownSymbol('match'); // `IsRegExp` abstract operation
// https://tc39.github.io/ecma262/#sec-isregexp

var isRegexp$1 = function (it) {
  var isRegExp;
  return isObject(it) && ((isRegExp = it[MATCH$3]) !== undefined ? !!isRegExp : classofRaw(it) == 'RegExp');
...
var BROKEN_CARET$1 = fails(function () {
  // https://bugzilla.mozilla.org/show_bug.cgi?id=773687
  var re = RE('^r', 'gy');
  re.lastIndex = 2;
  return re.exec('str') != null;
...
var setSpecies$1 = function (CONSTRUCTOR_NAME) {
  ...
  if (descriptors && Constructor && !Constructor[SPECIES$8]) {
...
var MATCH$4 = wellKnownSymbol('match');
var NativeRegExp$1 = global_1.RegExp;
var RegExpPrototype$3 = NativeRegExp$1.prototype;
var re1$1 = /a/g;
var re2$1 = /a/g; // "new" should create a new object, old webkit bug

var CORRECT_NEW$1 = new NativeRegExp$1(re1$1) !== re1$1;
var UNSUPPORTED_Y$5 = regexpStickyHelpers$1.UNSUPPORTED_Y;
var FORCED$5 = descriptors && isForced_1('RegExp', !CORRECT_NEW$1 || UNSUPPORTED_Y$5 || fails(function () {
  re2$1[MATCH$4] = false; // RegExp constructor can alter flags and IsRegExp works correct with @@match
...
if (FORCED$5) {
  var RegExpWrapper$1 = function RegExp(pattern, flags) {
    ...
    var result = inheritIfRequired$1(CORRECT_NEW$1 ? new NativeRegExp$1(pattern, flags) : NativeRegExp$1(pattern, flags), thisIsRegExp ? this : RegExpPrototype$3, RegExpWrapper$1);
    if (UNSUPPORTED_Y$5 && sticky) setInternalState$7(result, {
      sticky: sticky
    });
    return result;
  };
  ...
  var proxy$1 = function (key) {
    key in RegExpWrapper$1 || defineProperty$d(RegExpWrapper$1, key, {
      configurable: true,
      get: function () {
        return NativeRegExp$1[key];
      },
      set: function (it) {
        NativeRegExp$1[key] = it;
      }
    });
  };

  var keys$4 = getOwnPropertyNames$3(NativeRegExp$1);
  var index$1 = 0;

  while (keys$4.length > index$1) proxy$1(keys$4[index$1++]);

  RegExpPrototype$3.constructor = RegExpWrapper$1;
  RegExpWrapper$1.prototype = RegExpPrototype$3;
  redefine(global_1, 'RegExp', RegExpWrapper$1);
...
var UNSUPPORTED_Y$6 = regexpStickyHelpers$1.UNSUPPORTED_Y || regexpStickyHelpers$1.BROKEN_CARET; // nonparticipating capturing group, copied from es5-shim's String#split patch.
...
var regexpExec$1 = patchedExec$1;_export({
  target: 'RegExp',
  proto: true,
...
if ( !has(IteratorPrototype$3, ITERATOR$8)) {
  createNonEnumerableProperty(IteratorPrototype$3, ITERATOR$8, returnThis$2);
}

var iteratorsCore$1 = {
  IteratorPrototype: IteratorPrototype$3,
  BUGGY_SAFARI_ITERATORS: BUGGY_SAFARI_ITERATORS$2
};var iterators$1 = {};var IteratorPrototype$4 = iteratorsCore$1.IteratorPrototype;
...
var defineIterator$1 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if (anyNativeIterator) {
    ...
    if (IteratorPrototype$5 !== Object.prototype && CurrentIteratorPrototype.next) {
      if ( objectGetPrototypeOf$1(CurrentIteratorPrototype) !== IteratorPrototype$5) {
        ...
        } else if (typeof CurrentIteratorPrototype[ITERATOR$9] != 'function') {
          createNonEnumerableProperty(CurrentIteratorPrototype, ITERATOR$9, returnThis$4);
        }
      } // Set @@toStringTag to native iterators
  ...
  if ( IterablePrototype[ITERATOR$9] !== defaultIterator) {
    createNonEnumerableProperty(IterablePrototype, ITERATOR$9, defaultIterator);
  }
...
var REPLACE$1 = wellKnownSymbol('replace'); // Safari <= 13.0.3(?) substitutes nth capture where n>m with an empty string
...
};var charAt$9 = stringMultibyte$1.charAt; // `AdvanceStringIndex` abstract operation
...
fixRegexpWellKnownSymbolLogic$1('replace', 2, function (REPLACE, nativeReplace, maybeCallNative, reason) {
  ...
  function (regexp, replaceValue) {
    ...
    for (var i = 0; i < results.length; i++) {
      ...
      var position = max$5(min$9(toInteger(result.index), S.length), 0);
      var captures = []; // NOTE: This is equivalent to
      //   captures = result.slice(1).map(maybeToString)
      // but for some reason `nativeSlice.call(result, 1, result.length)` (called in
      // the slice polyfill when slicing native arrays) "doesn't work" in safari 9 and
...
var getIteratorMethod$1 = function (it) {
  if (it != undefined) return it[ITERATOR$b] || it['@@iterator'] || iterators$1[classof$1(it)];
...
try {
  ...
  iteratorWithReturn$1[ITERATOR$c] = function () {
    return this;
...
var id$3 = 0; // fallback for uncaught frozen keys
...
var collectionWeak$1 = {
  getConstructor: function (wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
    ...
    var define = function (that, key, value) {
      var state = getInternalState(that);
      var data = getWeakData$1(anObject(key), true);
      if (data === true) uncaughtFrozenStore$1(state).set(key, value);else data[state.id] = value;
      return that;
    };
  ...
  var $WeakMap = module.exports = collection$1('WeakMap', wrapper, collectionWeak$1); // IE11 WeakMap frozen keys fix
  // We can't use feature detection because it crash some old IE builds
  // https://github.com/zloirock/core-js/issues/485
...
defineWellKnownSymbol('iterator');function _typeof(obj) {
...
var fastKey = internalMetadata$1.fastKey;
...
var collectionStrong = {
  getConstructor: function (wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
    ...
    if (descriptors) defineProperty$e(C.prototype, 'size', {
      get: function () {
...
}, collectionStrong);var FAILS_ON_PRIMITIVES$7 = fails(function () {
...
_export({
  target: 'Array',
  proto: true,
  forced: !HAS_SPECIES_SUPPORT$5 || !USES_TO_LENGTH$4
}, {
  slice: function slice(start, end) {
    var O = toIndexedObject(this);
    var length = toLength(O.length);
    ...
    if (isArray(O)) {
      ...
      if (typeof Constructor == 'function' && (Constructor === Array || isArray(Constructor.prototype))) {
        ...
        Constructor = Constructor[SPECIES$a];
        if (Constructor === null) Constructor = undefined;
      }
...
var floor$2$1 = Math.floor; // `ToInteger` abstract operation
// https://tc39.es/ecma262/#sec-tointeger

var toInteger$1 = function toInteger(argument) {
  return isNaN(argument = +argument) ? 0 : (argument > 0 ? floor$2$1 : ceil$3)(argument);
...
var createMethod$1$1 = function createMethod$1(CONVERT_TO_STRING) {
  return function ($this, pos) {
...
var EXISTS$3 = isObject$2(document$1$1) && isObject$2(document$1$1.createElement);

var documentCreateElement$2 = function documentCreateElement(it) {
  return EXISTS$3 ? document$1$1.createElement(it) : {};
...
var f$4$1 = descriptors$2 ? $defineProperty$3 : function defineProperty(O, P, Attributes) {
  anObject$2(O);
...
var functionToString$3 = Function.toString; // this helper broken in `3.4.1-3.4.4`, so we can't use `shared` helper
...
var uid$2 = function uid(key) {
  return 'Symbol(' + String(key === undefined ? '' : key) + ')_' + (++id$4 + postfix$2).toString(36);
};
...
var set$2, get$2, has$3;

var enforce$2 = function enforce(it) {
  return has$3(it) ? get$2(it) : set$2(it, {});
};
...
var $propertyIsEnumerable$4 = {}.propertyIsEnumerable; // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe

var getOwnPropertyDescriptor$1$1 = Object.getOwnPropertyDescriptor; // Nashorn ~ JDK8 bug

var NASHORN_BUG$2 = getOwnPropertyDescriptor$1$1 && !$propertyIsEnumerable$4.call({
  1: 2
}, 1); // `Object.prototype.propertyIsEnumerable` method implementation
// https://tc39.es/ecma262/#sec-object.prototype.propertyisenumerable

var f$3$1 = NASHORN_BUG$2 ? function propertyIsEnumerable(V) {
...
var split$5 = ''.split; // fallback for non-array-like ES3 and non-enumerable old V8 strings
...
var indexedObject$2 = fails$2(function () {
  ...
  return classofRaw$2(it) == 'String' ? split$5.call(it, '') : Object(it);
...
var f$2$1 = descriptors$2 ? $getOwnPropertyDescriptor$3 : function getOwnPropertyDescriptor(O, P) {
...
var createMethod$a = function createMethod(IS_INCLUDES) {
  return function ($this, el, fromIndex) {
...
var returnThis$5 = function returnThis() {
  return this;
};
    ...
    if (IteratorPrototype$6 !== Object.prototype && CurrentIteratorPrototype.next) {
      if (objectGetPrototypeOf$2(CurrentIteratorPrototype) !== IteratorPrototype$6) {
        if (objectSetPrototypeOf$2) {
          ...
          createNonEnumerableProperty$2(CurrentIteratorPrototype, ITERATOR$4$1, returnThis$5);
        }
      } // Set @@toStringTag to native iterators
...
var charAt$a = stringMultibyte$2.charAt;
...
var aFunction$3 = function aFunction(it) {
  if (typeof it != 'function') {
    throw TypeError(String(it) + ' is not a function');
  }
    ...
    for (i = 0; i < input.length; i++) {
      ...
      if (currentValue == n) {
        ...
        k += base$1) {
          ...
          output.push(stringFromCharCode(digitToBasic$1(t + qMinusT % baseMinusT)));
          q = floor$1$1(qMinusT / baseMinusT);
        }

        output.push(stringFromCharCode(digitToBasic$1(q)));
...
var getInternalState$7 = internalState$2.getterFor(ARRAY_ITERATOR$2); // `Array.prototype.entries` method
// https://tc39.es/ecma262/#sec-array.prototype.entries
// `Array.prototype.keys` method
// https://tc39.es/ecma262/#sec-array.prototype.keys
// `Array.prototype.values` method
...
var redefineAll$2 = function redefineAll(target, src, options) {
  for (var key in src) {
...
/* init */
{
  anInstance$2(this, URLSearchParamsConstructor$1, URL_SEARCH_PARAMS$1);
  var init = arguments.length > 0 ? arguments[0] : undefined;
  var that = this;
  var entries = [];
  var iteratorMethod, iterator, next, step, entryIterator, entryNext, first, second, key;
...
redefineAll$2(URLSearchParamsPrototype$1, {
  // `URLSearchParams.prototype.append` method
  // https://url.spec.whatwg.org/#dom-urlsearchparams-append
  append: function append(name, value) {
...
if (!nativeUrl$1 && typeof $fetch == 'function' && typeof Headers$1 == 'function') {
  _export$2({
    global: true,
    enumerable: true,
    forced: true
...
var setInternalState$c = internalState$2.set;
...
/* , base */
  ...
  var that = anInstance$2(this, URLConstructor$1, 'URL');
  var base = arguments.length > 1 ? arguments[1] : undefined;
  var urlString = String(url);
  var state = setInternalState$c(that, {
    type: 'URL'
  });
  var baseState, failure;
...
var vimeo = {
  ...
  ready: function ready() {
    ...
    var premium = config.premium,
        ...
        frameParams = _objectWithoutProperties(config, ["premium", "referrerPolicy"]); // Get the source URL or ID
    ...
    var params = buildUrlParams(_objectSpread2(_objectSpread2({
