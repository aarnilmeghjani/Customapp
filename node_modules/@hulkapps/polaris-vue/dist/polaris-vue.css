/*! PolarisVue v3.0.9 | MIT License | github.com/hulkapps/polaris-vue */
@charset "UTF-8";
/*!
 * Quill Editor v1.3.7
 * https://quilljs.com/
...
.critical--text {
  ...
  caret-color: #d82c0d !important;
}

.warning {
  background-color: #ffc453 !important;
  border-color: #ffc453 !important;
}

.warning--text {
  color: #ffc453 !important;
  caret-color: #ffc453 !important;
}

.highlight {
  background-color: #5bcdda !important;
  border-color: #5bcdda !important;
}

.highlight--text {
  color: #5bcdda !important;
  caret-color: #5bcdda !important;
}
...
.Polaris-ActionList__Title + .Polaris-ActionList__Actions {
  padding-top: 0.8rem;
}
...
.Polaris-Breadcrumbs__Breadcrumb:after {
  ...
  pointer-events: none;
  box-shadow: 0 0 0 -0.2rem #458fff;
  transition: box-shadow 0.1s cubic-bezier(0.4, 0.22, 0.28, 1);
  border-radius: 0.5rem;
}
...
.Polaris-Breadcrumbs__Breadcrumb:focus:not(:active):after {
  box-shadow: 0 0 0 0.2rem #2C6ECB;
  outline: 0.1rem solid transparent;
}
.Polaris-Breadcrumbs__Breadcrumb:focus:not(:active) .Polaris-Breadcrumbs__ContentWrapper {
  position: relative;
}
...
.Polaris-TextField__ClearButton:focus:enabled svg {
  fill: #5c5f62;
}
.Polaris-TextField__ClearButton:focus:enabled img {
...
.Polaris-TextField__ClearButton:hover:enabled img {
  -webkit-filter: brightness(0) saturate(100%) invert(45%) sepia(8%) saturate(825%) hue-rotate(166deg) brightness(95%) contrast(90%);
  filter: brightness(0) saturate(100%) invert(45%) sepia(8%) saturate(825%) hue-rotate(166deg) brightness(95%) contrast(90%);
}
...
.Polaris-TextField__Segment:active {
  background: linear-gradient(180deg, #f6f6f7, #f6f6f7);
...
.Polaris-TextField--globalTheming {
	.Polaris-TextField--hasValue {
		color: var(--p-text-on-surface);
	}
	...
	.Polaris-TextField__Backdrop {
		...
		border: .1rem solid var(--p-border-subdued-on-surface);
...
.Polaris-TextField--globalTheming.Polaris-TextField--error {
...
.Polaris-Button--primary {
  --p-button-color: rgba(0, 128, 96, 1);
  --p-button-text: rgba(255, 255, 255, 1);
  --p-button-color-hover: rgba(0, 110, 82, 1);
  --p-button-color-active: rgba(0, 94, 70, 1);
  --p-button-color-depressed: rgba(0, 61, 44, 1);
  position: relative;
...
.Polaris-Button--primary.Polaris-Button--pressed:hover, .Polaris-Button--primary.Polaris-Button--pressed:focus {
  background: var(--p-button-color-depressed);
  box-shadow: 0 1px 0 rgba(0, 0, 0, 0.05), inset 0 -1px 0 rgba(0, 0, 0, 0.2);
}
...
.Polaris-Button--destructive {
  --p-button-color: rgba(216, 44, 13, 1);
  --p-button-text: rgba(255, 255, 255, 1);
  --p-button-color-hover: rgba(188, 34, 0, 1);
  --p-button-color-active: rgba(162, 27, 0, 1);
  --p-button-color-depressed: rgba(108, 15, 0, 1);
  position: relative;
  background: var(--p-button-color);
  border-width: 0;
  border-color: transparent;
...
.Polaris-Button--destructive.Polaris-Button--pressed:hover, .Polaris-Button--destructive.Polaris-Button--pressed:focus {
  background: var(--p-button-color-depressed);
  box-shadow: 0 1px 0 rgba(0, 0, 0, 0.05), inset 0 -1px 0 rgba(0, 0, 0, 0.2);
}
...
.Polaris-Button--destructiveText {
  color: #d82c0d;
}
.Polaris-Button--destructiveText:hover {
  color: #d82c0d;
}
.Polaris-Button--destructiveText svg {
  fill: #d82c0d;
}
...
.Polaris-Button--outline.Polaris-Button--destructive {
  background: transparent;
  border: 0.1rem solid #fd5749;
  box-shadow: none;
  color: #d82c0d;
}

.Polaris-Button--outline.Polaris-Button--primary {
  background: transparent;
...
.Polaris-Button--outline.Polaris-Button--destructive.Polaris-Button--pressed {
  background: #fff4f4;
  box-shadow: 0.1rem solid #fd5749;
  color: #d82c0d;
}
...
.Polaris-Button--plainAction {
  border: unset;
  box-shadow: unset;
  background: transparent;
}

.Polaris-Button--plainAction.Polaris-Button {
  box-shadow: unset;
}

.Polaris-Button--plainAction.Polaris-Button--destructive {
  border: unset;
  background: transparent;
  color: #d82c0d;
}

.Polaris-Button--plainAction.Polaris-Button--primary {
  border: unset;
  background: transparent;
  color: #008060;
}
...
.Polaris-Button--monochrome.Polaris-Button--outline::after {
  ...
  display: block;
  pointer-events: none;
  box-shadow: 0 0 0 -0.3rem #458fff;
  transition: box-shadow 100ms cubic-bezier(0.4, 0.22, 0.28, 1);
  border-radius: 0.5rem;
}
...
.Polaris-Button__ConnectedDisclosureWrapper .Polaris-Button::after {
  box-shadow: unset;
}
...
.Polaris-ButtonGroup--segmented .Polaris-Button::after {
  box-shadow: unset;
}
...
.Polaris-Checkbox__Input:active:not(:disabled) ~ .Polaris-Checkbox__Icon, .Polaris-Checkbox__Input:checked ~ .Polaris-Checkbox__Icon, .Polaris-Checkbox__Input.Polaris-Checkbox__Input--indeterminate ~ .Polaris-Checkbox__Icon {
  transition: opacity 150ms cubic-bezier(0.4, 0.22, 0.28, 1), transform 150ms cubic-bezier(0.4, 0.22, 0.28, 1);
...
.Polaris-Checkbox--error .Polaris-Checkbox__Input:checked + .Polaris-Checkbox__Backdrop::before, .Polaris-Checkbox--error .Polaris-Checkbox__Input:active + .Polaris-Checkbox__Backdrop::before, .Polaris-Checkbox--error .Polaris-Checkbox__Input.Polaris-Checkbox__Input--indeterminate + .Polaris-Checkbox__Backdrop::before {
  background-color: #fd5749;
}
...
.Polaris-Card.theme--dark .Polaris-Card__Section--subdued {
...
.Polaris-Card.theme--light .Polaris-Card__Section--subdued {
...
.Polaris-RadioButton__Input:active + .Polaris-RadioButton__Backdrop {
  background: #2C6ECB;
  box-shadow: 0 0 0 1px #2C6ECB, 0 0 0 0 transparent;
}
...
.Polaris-Modal-Dialog:focus-visible {
  outline: unset;
}
...
.Polaris-Filters-ConnectedFilterControl .Polaris-Filters-ConnectedFilterControl__CenterContainer + .Polaris-Filters-ConnectedFilterControl__RightContainer {
  margin-left: 0.8rem;
}
...
.Polaris-Filters-ConnectedFilterControl__RightContainer .Polaris-Filters-ConnectedFilterControl__Item:first-child > * {
...
.Polaris-Filters-ConnectedFilterControl__RightContainer .Polaris-Filters-ConnectedFilterControl__Item:last-child > * {
...
.Polaris-Navigation__Item::after {
  ...
  display: block;
  pointer-events: none;
  box-shadow: 0 0 0 -0.1rem #007B5C;
  transition: box-shadow 100ms cubic-bezier(0.4, 0.22, 0.28, 1);
  border-radius: 3px;
}
...
.Polaris-Navigation__Item--selected .Polaris-Navigation__Icon img, .Polaris-Navigation__Item--selected:hover .Polaris-Navigation__Icon img, .Polaris-Navigation--subNavigationActive .Polaris-Navigation__Icon img, .Polaris-Navigation--subNavigationActive:hover .Polaris-Navigation__Icon img, .Polaris-Navigation__Item--selected.Polaris-Navigation--keyFocused .Polaris-Navigation__Icon img {
  filter: brightness(0) saturate(100%) invert(20%) sepia(59%) saturate(5557%) hue-rotate(162deg) brightness(95%) contrast(101%);
}
...
.Polaris-Navigation__SecondaryNavigation .Polaris-Navigation__Item--selected.Polaris-Navigation--keyFocused {
  color: #007b5c;
}
...
.Polaris-Frame__Navigation--display {
  display: flex;
}
...
.Polaris-Frame__NavigationDismiss:focus {
  position: absolute;
  border-radius: 3px;
  background-color: var(transparent, rgba(255, 255, 255, 0.16));
  outline: none;
}
...
.Polaris-Banner--withinContentContainer.Polaris-Banner--statusInfo:focus {
  outline: none;
  box-shadow: var(--p-banner-border, inset 0 3px 0 0 var(--p-highlight-border, #006e52), inset 0 0 0 3px var(--p-highlight-border, #006e52), 0 0 0 1px rgba(63, 63, 68, 0.05), 0 1px 3px 0 rgba(63, 63, 68, 0.15));
  position: relative;
}
...
.Polaris-Banner--withinPage {
  ...
  transition: box-shadow 0.2s cubic-bezier(0.64, 0, 0.35, 1);
  transition-delay: 0.1s;
  box-shadow: #babfc3 0px 1px 0px 0px inset, #babfc3 0px 0px 0px 1px inset;
  background-color: #f6f6f7;
}
...
.Polaris-Banner--withinPage.Polaris-Banner--statusSuccess {
  ...
  transition: box-shadow 0.2s cubic-bezier(0.64, 0, 0.35, 1);
  transition-delay: 0.1s;
  box-shadow: #95c9b4 0px 1px 0px 0px inset, #95c9b4 0px 0px 0px 1px inset;
...
.Polaris-Banner--withinPage.Polaris-Banner--statusInfo {
  ...
  transition: box-shadow 0.2s cubic-bezier(0.64, 0, 0.35, 1);
  transition-delay: 0.1s;
  box-shadow: var(--p-banner-border, inset 0 3px 0 0 var(--p-highlight-border, #006e52), inset 0 0 0 0 transparent, 0 0 0 1px rgba(63, 63, 68, 0.05), 0 1px 3px 0 rgba(63, 63, 68, 0.15));
  background-color: #eef9f9;
}
@media (-ms-high-contrast: active) {
  .Polaris-Banner--withinPage.Polaris-Banner--statusInfo {
...
.Polaris-Banner--withinPage.Polaris-Banner--statusWarning {
  transition: box-shadow 0.2s cubic-bezier(0.64, 0, 0.35, 1);
  transition-delay: 0.1s;
  box-shadow: #e1b878 0px 1px 0px 0px inset, #e1b878 0px 0px 0px 1px inset;
...
.Polaris-Banner--withinPage.Polaris-Banner--statusCritical:focus:after {
  ...
  left: -0.3rem;
  display: block;
  border: calc(var(--p-border-radius-wide) + 0.3rem);
  border-radius: 0.2rem solid var(--p-interactive-focus);
  pointer-events: none;
}
...
.Polaris-Select.invalid .multiselect__tags {
  border-color: #bf0711;
...
.Polaris-Select__Backdrop {
  ...
  box-shadow: 0 0 0 -0.2rem #2C6ECB !important;
  border-radius: 0.4rem;
  transition-property: box-shadow, background-color;
  transition-duration: 0.2s;
  transition-timing-function: cubic-bezier(0.64, 0, 0.35, 1);
...
.Polaris-Stack--spacingNone > .Polaris-Stack__Item:not(:empty) {
  margin-top: 0;
  margin-left: 0;
  max-width: 100%;
}
...
.Polaris-Stack--spacingExtraTight > .Polaris-Stack__Item:not(:empty) {
  margin-top: 0.4rem;
  margin-left: 0.4rem;
  max-width: 100%;
}
...
.Polaris-Stack--spacingTight > .Polaris-Stack__Item:not(:empty) {
  margin-top: 0.8rem;
  margin-left: 0.8rem;
  max-width: 100%;
}
...
.Polaris-Stack--spacingBaseTight > .Polaris-Stack__Item:not(:empty) {
  margin-top: 1.2rem;
  margin-left: 1.2rem;
  max-width: 100%;
}
...
.Polaris-Stack--spacingLoose > .Polaris-Stack__Item:not(:empty) {
  margin-top: 2rem;
  margin-left: 2rem;
  max-width: 100%;
}
...
.Polaris-Stack--spacingExtraLoose > .Polaris-Stack__Item:not(:empty) {
  margin-top: 3.2rem;
  margin-left: 3.2rem;
  max-width: 100%;
}
...
.Polaris-Stack--distributionFill > .Polaris-Stack__Item:not(:empty) {
  flex: 1 1 auto;
}

.Polaris-Stack--distributionFillEvenly > .Polaris-Stack__Item:not(:empty) {
  flex: 1 1 auto;
}
...
.Polaris-Stack--vertical > .Polaris-Stack__Item:not(:empty) {
  margin-left: 0;
}
...
.Polaris-DataTable__Cell--header {
  font-weight: 400;
  color: #212b36;
  border-bottom: 0.1rem solid #8c9196;
  border-top: none;
}
...
@media (max-width: 30.625em), (min-width: 48.0625em) and (max-width: 47.125em) {
  [data-has-navigation] .Polaris-Pagination {
    display: flex;
    width: 100%;
  }

  [data-has-navigation] .Polaris-Pagination .Polaris-Pagination__Button {
    flex: 1 0 auto;
  }
}
@media (max-width: 30.625em) {
  ...
  .Polaris-Pagination .Polaris-Pagination__Button {
    flex: 1 0 auto;
  }
}
...
.Polaris-Pagination__Button:hover {
  background: linear-gradient(180deg, #f9fafb, #f6f6f7);
  border-color: #babfc3;
}
...
.Polaris-ResourceList-BulkActions__Slide {
  ...
  will-change: transform;
  transform: translateY(0);
  transition: transform 0.2s cubic-bezier(0.64, 0, 0.35, 1);
}
...
.Polaris-ResourceList__ResourceListWrapper.theme--dark .Polaris-ResourceItem:hover {
  background-color: #272727;
  color: #FFFFFF;
}
.Polaris-ResourceList__ResourceListWrapper.theme--dark .Polaris-ResourceList__HeaderWrapper {
  background-color: #1E1E1E;
  color: #FFFFFF;
}
.Polaris-ResourceList__ResourceListWrapper.theme--dark .Polaris-Checkbox__Backdrop {
  background-color: unset;
}
.Polaris-ResourceList__ResourceListWrapper.theme--dark .Polaris-ResourceList-BulkActions__BulkActionButton .Polaris-Button {
  background-color: inherit;
  color: unset;
}
.Polaris-ResourceList__ResourceListWrapper.theme--dark .Polaris-ResourceList-BulkActions__BulkActionButton .Polaris-Button.Polaris-Button--plain {
  color: #2C6ECB;
}
.Polaris-ResourceList__ResourceListWrapper.theme--dark .Polaris-ResourceList-BulkActions__BulkActionButton .Polaris-Button.Polaris-Button--plain:hover {
  background-color: unset;
  color: #1f5199;
}
.Polaris-ResourceList__ResourceListWrapper.theme--dark .Polaris-ResourceList-BulkActions__BulkActionButton .Polaris-Button:hover {
  background-color: #272727;
  color: #FFFFFF;
}
.Polaris-ResourceList__ResourceListWrapper.theme--dark .Polaris-ResourceList__SortWrapper .Polaris-Select__Backdrop {
  background-color: #1E1E1E !important;
  color: #FFFFFF;
}
...
.Polaris-ResourceList__ResourceListWrapper.theme--light .Polaris-ResourceItem:hover {
  background-color: #f5f5f5;
  color: #000000;
}
.Polaris-ResourceList__ResourceListWrapper.theme--light .Polaris-ResourceList__HeaderWrapper {
  background-color: #FFFFFF;
  color: #000000;
}
.Polaris-ResourceList__ResourceListWrapper.theme--light .Polaris-Checkbox__Backdrop {
  background-color: unset;
}
.Polaris-ResourceList__ResourceListWrapper.theme--light .Polaris-ResourceList-BulkActions__BulkActionButton .Polaris-Button {
  background-color: inherit;
  color: unset;
}
.Polaris-ResourceList__ResourceListWrapper.theme--light .Polaris-ResourceList-BulkActions__BulkActionButton .Polaris-Button.Polaris-Button--plain {
  color: #2C6ECB;
}
.Polaris-ResourceList__ResourceListWrapper.theme--light .Polaris-ResourceList-BulkActions__BulkActionButton .Polaris-Button.Polaris-Button--plain:hover {
  background-color: unset;
  color: #1f5199;
}
.Polaris-ResourceList__ResourceListWrapper.theme--light .Polaris-ResourceList-BulkActions__BulkActionButton .Polaris-Button:hover {
  background-color: #f5f5f5;
  color: #000000;
}
.Polaris-ResourceList__ResourceListWrapper.theme--light .Polaris-ResourceList__SortWrapper .Polaris-Select__Backdrop {
  background-color: #FFFFFF !important;
  color: #000000;
}
...
.Polaris-Tabs__Wrapper {
  border-bottom: 0.1rem solid #cacccf;
  padding: 0 0.8rem;
}
...
.Polaris-Tabs__Tab:visited > .Polaris-Tabs__Title {
  color: inherit;
}
...
.Polaris-Scrollable--hasTopShadow.Polaris-Scrollable--hasBottomShadow {
  box-shadow: inset 0 2rem 2rem -2rem rgba(0, 0, 0, 0.15), inset 0 -2rem 2rem -2rem rgba(0, 0, 0, 0.15);
}
...
.Polaris-TextStyle--variationCode {
  ...
  display: inline-block;
  font-size: 1.15em;
  box-shadow: inset 0 0 0 1px #c9cccf;
}
...
.Polaris-ActionMenu-MenuAction:focus:after {
  background: rgba(33, 43, 54, 0.1);
}
.Polaris-ActionMenu-MenuAction:active {
  color: inherit;
}
.Polaris-ActionMenu-MenuAction:active .Polaris-ActionMenu-MenuAction__IconWrapper svg {
  fill: #212b36;
  color: #fff;
}
.Polaris-ActionMenu-MenuAction:active:after {
  background: #edeeef;
}
.Polaris-ActionMenu-MenuAction:hover {
  color: inherit;
}
.Polaris-ActionMenu-MenuAction:hover .Polaris-ActionMenu-MenuAction__IconWrapper svg {
  fill: #212b36;
  color: #fff;
}
...
@media screen and (-ms-high-contrast: active) {
  .Polaris-Sheet {
    border-left: 0.1rem solid #c9cccf;
  }
}
@media (min-width: 48.0625em) {
  .Polaris-Sheet {
...
.Polaris-FooterHelp__Content {
  ...
  border-top: 0.1rem solid #c9cccf;
  border-bottom: 0.1rem solid #c9cccf;
  width: 100%;
  justify-content: center;
}
@media (min-width: 30.625em) {
...
.Polaris-KeyboardKey {
  ...
  padding: 0 0.4rem;
  background-color: white;
  box-shadow: 0 0 0 1px #c9cccf, 0 2px 0 0 white, 0 2px 0 1px #c9cccf;
  border-radius: 0.4rem;
  font-family: -apple-system, BlinkMacSystemFont, San Francisco, Segoe UI, Roboto, Helvetica Neue, sans-serif;
  font-size: 1.2rem;
  font-weight: 500;
...
.Polaris-Link.Polaris-Link--monochrome {
  color: inherit;
  text-decoration: underline;
}
.Polaris-Link.Polaris-Link--monochrome:active {
  color: inherit;
}
.Polaris-Link.Polaris-Link--monochrome:focus {
  color: inherit;
}
.Polaris-Link.Polaris-Link--monochrome:hover {
  color: inherit;
}
...
.Polaris-ResourceItem--selected.Polaris-ResourceItem--focused {
  box-shadow: inset 0.2rem 0 0 #007B5C;
  background-color: linear-gradient(rgba(179, 188, 245, 0.15), rgba(179, 188, 245, 0.15)), linear-gradient(rgba(223, 227, 232, 0.3), rgba(223, 227, 232, 0.3));
}
.Polaris-ResourceItem--selected.Polaris-ResourceItem--focused:hover {
  box-shadow: inset 0.2rem 0 0 #007B5C;
  background-color: linear-gradient(rgba(179, 188, 245, 0.15), rgba(179, 188, 245, 0.15)), linear-gradient(rgba(223, 227, 232, 0.3), rgba(223, 227, 232, 0.3)), linear-gradient(rgba(223, 227, 232, 0.3), rgba(223, 227, 232, 0.3));
}

.Polaris-ResourceItem--focused {
  box-shadow: inset 0.2rem 0 0 #007B5C;
  background-color: linear-gradient(rgba(223, 227, 232, 0.3), rgba(223, 227, 232, 0.3));
}
.Polaris-ResourceItem--focused:hover {
  box-shadow: inset 0.2rem 0 0 #007B5C;
  background-color: linear-gradient(rgba(223, 227, 232, 0.3), rgba(223, 227, 232, 0.3)), linear-gradient(rgba(223, 227, 232, 0.3), rgba(223, 227, 232, 0.3));
}
.Polaris-ResourceItem--focused:active {
  box-shadow: inset 0.2rem 0 0 #007B5C;
  background-color: linear-gradient(rgba(223, 227, 232, 0.3), rgba(223, 227, 232, 0.3)), linear-gradient(rgba(179, 188, 245, 0.1), rgba(179, 188, 245, 0.1));
}
...
@media (max-width: 48.0525em) {
  .Polaris-TopBar-Menu__Activator:active, .Polaris-TopBar-Menu__Activator:focus, .Polaris-TopBar-Menu__Activator:hover, .Polaris-TopBar-Menu__Activator[aria-expanded=true] {
    background-color: initial;
    opacity: 0.85;
  }
}
...
@media (min-width: 48.0625em) {
  .Polaris-TopBar__LogoContainer {
    ...
    padding: 0 0.8rem 0 calc(1.6rem + env(safe-area-inset-left));
  }
}
...
/*.multiselect__placeholder:after{
    ...
    pointer-events: none;
    transition: box-shadow 0.1s var(--p-ease);
    box-shadow: 0 0 0 -0.2rem $theme-shadow-color;
...
div.multiselect, input.multiselect__input, div.multiselect__single {
  font-size: unset;
}
...
div.multiselect .multiselect__select svg {
  margin: 4px 0;
  width: 20px;
  fill: #637381;
}
...
div.multiselect .multiselect__tags-wrap > .Polaris-Tag {
...
div.multiselect .multiselect__tag-icon:focus, div.multiselect .multiselect__tag-icon:hover {
  background: unset;
  outline: none;
}
...
@media (min-width: 48.0625em) and (max-width: 47.125em) {
  [data-has-navigation] .Polaris-EmptyState__ImageContainer {
    overflow-x: hidden;
  }
  [data-has-navigation] .Polaris-EmptyState__DetailsContainer {
...
.Polaris-Frame-Toast-Fade-In-Down {
...
.Polaris-Frame-Toast-Fade-In-Up {
...
.Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-top .Polaris-Frame-Toast {
  margin-top: 2rem;
}
.Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-bottom .Polaris-Frame-Toast {
  margin-bottom: 2rem;
}
.Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-top-right .Polaris-Frame-Toast {
  margin-top: 2rem;
  margin-right: 2rem;
}
.Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-bottom-right .Polaris-Frame-Toast {
  margin-bottom: 2rem;
  margin-right: 2rem;
}
.Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-top-left .Polaris-Frame-Toast {
  margin-top: 2rem;
  margin-left: 2rem;
}
.Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-bottom-left .Polaris-Frame-Toast {
  margin-bottom: 2rem;
  margin-left: 2rem;
}
.Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-top, .Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-bottom {
  align-self: center;
}
.Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-top-right, .Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-bottom-right {
  align-self: flex-end;
}
.Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-top-left, .Polaris-Frame-ToastManager.Polaris-Frame-Toast--Position-bottom-left {
  align-self: flex-start;
}
...
.Polaris-Frame-Toast-Wrapper.Polaris-Frame-Toast-Wrapper-Top {
  flex-direction: column;
}

.Polaris-Frame-Toast-Wrapper.Polaris-Frame-Toast-Wrapper-Bottom {
  flex-direction: column-reverse;
}
...
.Polaris-TopBar-SearchField--focused .Polaris-TopBar-SearchField__Input::-webkit-input-placeholder, .Polaris-TopBar-SearchField__Input:focus::-webkit-input-placeholder {
  color: #6d7175;
}
...
.Polaris-TopBar-SearchField__Input::-webkit-input-placeholder {
  color: #202223;
  -webkit-transition: 167ms color cubic-bezier(0.64, 0, 0.35, 1) 33ms;
  transition: 167ms color cubic-bezier(0.64, 0, 0.35, 1) 33ms;
}
...
.Polaris-TopBar-SearchField__Icon svg {
  transition: 167ms fill cubic-bezier(0.64, 0, 0.35, 1) 33ms;
}
...
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first.Table-unselectable .TableHeading-second,
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first.Table-unselectable .TableCell:first-child, .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell.Table-unselectable .TableHeading-second,
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell.Table-unselectable .TableCell:first-child, .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--first.Table-unselectable .TableHeading-second,
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--first.Table-unselectable .TableCell:first-child, .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--second.Table-unselectable .TableHeading-second,
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--second.Table-unselectable .TableCell:first-child {
  visibility: visible;
  filter: drop-shadow(1rem 0 0 #e1e3e5);
}
...
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first, .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--first {
  box-shadow: 0.1rem -0.1rem 0 0 #e1e3e5;
}
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first.Table-unselectable .TableHeading-second,
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first.Table-unselectable .TableCell:first-child, .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--first.Table-unselectable .TableHeading-second,
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--first.Table-unselectable .TableCell:first-child {
  visibility: visible;
  filter: drop-shadow(1rem 0 0 #e1e3e5);
}
...
@media (min-width: 28.625em) {
  .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first, .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--first {
    box-shadow: 0 -0.1rem 0 0 #e1e3e5;
  }
  .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first.Table-unselectable .TableHeading-second,
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first.Table-unselectable .TableCell:first-child, .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--first.Table-unselectable .TableHeading-second,
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--first.Table-unselectable .TableCell:first-child {
...
@media (min-width: 28.625em) {
  ...
  .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell.Table-unselectable .TableHeading-second,
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell.Table-unselectable .TableCell:first-child, .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--second.Table-unselectable .TableHeading-second,
.Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--second.Table-unselectable .TableCell:first-child {
    visibility: visible;
    filter: drop-shadow(1rem 0 0 #e1e3e5);
  }
...
.Polaris-IndexTable__TableRow {
  background-color: white;
  cursor: pointer;
  filter: drop-shadow(0 -0.1rem 0 #e1e3e5);
}
.Polaris-IndexTable__TableRow.TableRow-unclickable {
  cursor: auto;
}
...
@media screen and (min-width: 457px) and (max-width: 688px) {
  .Polaris-IndexTable__TableHeading--last {
    ...
    z-index: auto;
    background-color: white;
    filter: drop-shadow(-0.1rem 0 0 #e1e3e5);
  }
}
...
.Polaris-IndexTable__StickyTableColumnHeader--isScrolling {
  box-shadow: 1px 1px 0 0 #e1e3e5, 1px 0 1px 1px rgba(63, 63, 68, 0.05), 1px 0 3px 0 rgba(63, 63, 68, 0.15);
}
...
:root {
  --p-scroll-bar-content-width: 0px;
}
...
.Polaris-IndexTable-FirstStickyHeaderElement {
  margin-left: 2rem;
  padding-right: 2rem;
}

.Polaris-IndexTable-StickyTableHeading-second-scrolling {
  padding: 0 0.6rem 0 1.6rem;
  display: none;
}
@media (min-width: breakpoint(458px, 0)) {
  .Polaris-IndexTable-StickyTableHeading-second-scrolling {
    display: block;
  }
}

.Polaris-IndexTable-StickyTableHeading-second {
  padding-left: 0;
}
@media (min-width: breakpoint(458px, 0)) {
  .Polaris-IndexTable-StickyTableHeading-second {
...
.Polaris-IndexTable-StickyTableHeading-second.unselectable {
  display: none;
}

.Polaris-IndexTable-TableHeading-first {
  position: sticky;
  left: 0;
  padding-left: 14rem;
  padding-right: 18rem;
...
.Polaris-IndexTable-TableHeading-second:not(.TableHeading-unselectable) {
  padding-left: 0;
}
@media (min-width: breakpoint(458px, 0)) {
  .Polaris-IndexTable-TableHeading-second:not(.TableHeading-unselectable) {
...
.Polaris-IndexTable-TableHeading-second.TableHeading-unselectable {
  position: sticky;
  z-index: auto;
  left: 0;
}

.Table-unselectable .TableCell:first-child {
  left: 0;
  background-color: white;
  position: sticky;
  z-index: 31;
}
.Table-unselectable .statusSuccess .TableCell:first-child {
  background-color: #f1f8f5;
}
.Table-unselectable .statusSubdued .TableCell:first-child {
  background-color: #fafbfb;
}
.Table-unselectable .TableRow-hovered .TableCell:first-child {
  background-color: #f6f6f7;
}
...
@media screen and (min-width: 457px) {
  .Polaris-IndexTable__Table-sticky-scrolling, .Polaris-IndexTable__TableCell--last-child, .Polaris-IndexTable__TableHeading--last {
    filter: drop-shadow(-0.1rem 0 0 #e1e3e5);
  }
}

.Polaris-IndexTable-Table-sticky-last .Polaris-IndexTable-statusSuccess .Polaris-IndexTable__TableCell:last-child {
  background-color: #f1f8f5;
}
.Polaris-IndexTable-Table-sticky-last .Polaris-IndexTable-statusSubdued .Polaris-IndexTable__TableCell:last-child {
  background-color: #fafbfb;
}
.Polaris-IndexTable-Table-sticky-last .Polaris-IndexTable-TableRow-hovered .Polaris-IndexTable__TableCell:last-child {
  background-color: #f6f6f7;
}
.Polaris-IndexTable-Table-sticky-last .Polaris-IndexTable-TableRow-selected .Polaris-IndexTable__TableCell:last-child {
  background-color: #f2f7fe;
}
...
.Polaris-VerticalTabs__Navigation > ul {
  border-bottom: none;
}
.Polaris-VerticalTabs__Navigation .Polaris-VerticalTabs__Title:before {
  border-top-left-radius: 0 !important;
  border-top-right-radius: 0 !important;
}
...
.Polaris-Tooltip-TooltipOverlay {
  opacity: 1;
  box-shadow: 0 1px 5px rgba(23, 24, 24, 0.05);
  border-radius: 0.4rem;
  pointer-events: none;
  -webkit-backface-visibility: hidden;
  backface-visibility: hidden;
...
.Polaris-TooltipPositionedOverlay {
  position: absolute;
  z-index: 530;
}
...
:root {
  ...
  --header-background-collapsed-color: #f1f8f5;
...
.Polaris-Accordion-Title--collapsed {
  background-color: var(--header-background-collapsed-color);
}
...
.Polaris-Accordion-Title--slot {
  ...
  background-color: var(--header-background-color);
  overflow: hidden;
  transition: 0.15s ease-in-out, 0.15s ease-in-out, 0.15s ease-in-out, box-shadow 0.15s ease-in-out, border-radius 0.15s ease;
}
...
.Polaris-Accordion__IconFacingUp {
  transform: rotate(180deg);
}
...
.Polaris-Floating .Polaris-Floating--label {
...
.Polaris-Floating .Polaris-Floating--label--visible {
  display: block;
}
.Polaris-Floating .Polaris-Floating--label__prefix {
  border-radius: 0 0.4rem 0.4rem 0;
}
.Polaris-Floating .Polaris-Floating--label__suffix {
  border-radius: 0.4rem 0 0 0.4rem;
}
.Polaris-Floating .Polaris-FloatingLabels__Input {
  position: relative;
  border: 1px solid #c9cccf;
  border-radius: 0.4rem;
  display: block;
...
.Polaris-Floating .Polaris-FloatingLabels__Input:focus-visible {
  outline: none;
}
.Polaris-Floating .Polaris-FloatingLabels__Input:focus ~ .Polaris-TextField__Backdrop:after {
  box-shadow: 0 0 0 0.2rem #458FFF;
  outline: 0.1rem solid transparent;
}
.Polaris-Floating .Polaris-FloatingLabels__Input[type=number] {
  -webkit-appearance: textfield;
  -moz-appearance: textfield;
  appearance: textfield;
}
.Polaris-Floating .Polaris-FloatingLabels__Input--prefix {
  border-radius: 0 0.4rem 0.4rem 0;
  border-left: none;
}
.Polaris-Floating .Polaris-FloatingLabels__Input--suffix {
  border-radius: 0.4rem 0 0 0.4rem;
  border-right: none;
}
.Polaris-Floating .Polaris-FloatingLabels__Input--prefix.Polaris-FloatingLabels__Input--suffix {
  border-radius: 0;
}
.Polaris-Floating .Polaris-FloatingLabels__Input--number {
  border-radius: 0.4rem 0 0 0.4rem;
  border-right: none;
}
.Polaris-Floating .Polaris-FloatingLabels__Input:not(:placeholder-shown),
.Polaris-Floating .Polaris-FloatingLabels__Input:focus {
  padding: 21px 11px 5px;
}
.Polaris-Floating .Polaris-FloatingLabels__Input::placeholder {
  color: transparent;
  opacity: 0;
}
.Polaris-Floating .Polaris-FloatingLabels__Input:not(:placeholder-shown) + .Polaris-Floating--label,
.Polaris-Floating .Polaris-FloatingLabels__Input:focus + .Polaris-Floating--label {
  font-size: 0.83em;
  margin-top: 5px;
  margin-bottom: 0;
  padding: 0 11px;
...
.Polaris-Floating .Polaris-FloatingLabel__TextArea {
  min-height: 46.2px;
  flex: 1 1;
}
.Polaris-Floating .Polaris-Floating--label--select {
  pointer-events: none;
}
.Polaris-Floating .Polaris-FloatingField__Caret {
...
.Polaris-Select-Floating-Label {
  position: relative;
}

.Polaris-Select-Floating-Label .multiselect,
.Polaris-Select-Floating-Label .multiselect .multiselect__tags {
  min-height: 46.19px;
}

.Polaris-Select-Floating-Label .multiselect .multiselect__select {
  top: 5px;
  min-height: 41.19px;
}

.Polaris-Select-Floating-Label .Polaris-Labelled__LabelWrapper {
  position: absolute;
  z-index: 51;
  margin: 11px 0 10px;
  padding: 0 1rem;
...
.Polaris-Select-Floating-Label .multiselect.multiselect--active .multiselect__input {
  position: absolute;
  bottom: 0;
  right: 0;
  padding: 0 0.8rem 0 1.2rem;
...
.Polaris-Select-Floating-Label.Polaris-Select--Active .Polaris-Labelled__LabelWrapper,
.Polaris-Select-Floating-Label.Polaris-Select-Has-Value .Polaris-Labelled__LabelWrapper {
  font-size: 0.83em;
  margin-top: 5px;
  margin-bottom: 0;
  padding: 0 11px;
...
.Polaris-Select-Floating-Label.Polaris-Select--Active .multiselect__input {
  line-height: 18.2px;
  min-height: 18px;
  margin: 21px 0 0;
}

.Polaris-Select-Floating-Label.Polaris-Select--Active .multiselect.multiselect--active .multiselect__input,
.Polaris-Select-Floating-Label.Polaris-Select-Has-Value .multiselect.multiselect--active .multiselect__input {
  padding: 21px 11px 5px;
  line-height: 18.2px;
}

.Polaris-Select-Floating-Label div.multiselect .multiselect__tags-wrap {
  margin: 18px 0 0;
}
...
.Polaris-FloatingLabels__Input--select::after {
  box-shadow: 0 0 0 0.2rem #458fff;
  outline: 0.1rem solid transparent;
}

.Polaris-Select--Active .Polaris-FloatingLabels__Input--select {
  padding: 21px 9px 5px 9px;
}

.Polaris-Floating .Polaris-TextField > .Polaris-FloatingLabels__Input ~ .Polaris-TextField__Backdrop {
  background-color: #FFFFFF;
}

.Polaris-Floating .Polaris-TextField--error .Polaris-FloatingLabels__Input--error {
  background-color: #fbeae5;
  border-color: #bf0711;
}
.Polaris-Floating .Polaris-TextField--error .Polaris-FloatingLabels__Input--error:after {
  border-color: #bf0711;
}
.Polaris-Floating .Polaris-TextField--error > .Polaris-FloatingLabels__Input ~ .Polaris-TextField__Backdrop {
  background-color: #fbeae5;
  border-color: #bf0711;
}
.Polaris-Floating .Polaris-TextField--error > .Polaris-FloatingLabels__Input ~ .Polaris-TextField__Backdrop:after {
  border-color: #bf0711;
}
...
.Polaris-RangeSlider-SingleThumb__InputWrapper::after {
  ...
  height: 0.4rem;
  width: 100%;
  background-image: linear-gradient(to right, #8c9196, #8c9196 50%, transparent 50%, transparent 100%);
  background-size: 0.4rem 0.4rem;
  border-radius: 0.4rem;
  border-right: 0.4rem #8c9196 solid;
}
...
.Polaris-RangeSlider-SingleThumb__Input {
  --progress-lower: rgba(44, 110, 203, 1);
...
.Polaris-RangeSlider-SingleThumb__Input::-ms-thumb {
  ...
  border: 0.1rem solid transparent;
  border-radius: 50%;
  background: linear-gradient(#2c6ecb, #2c6ecb);
  box-shadow: 0 0 0 0 #458fff;
  appearance: none;
  -ms-transition: box-shadow 100ms cubic-bezier(0.4, 0.22, 0.28, 1);
  transition: box-shadow 100ms cubic-bezier(0.4, 0.22, 0.28, 1);
...
.Polaris-RangeSlider-SingleThumb__Input::-moz-range-thumb {
  ...
  box-shadow: 0 0 0 0 #458fff;
  appearance: none;
  -moz-transition: box-shadow 100ms cubic-bezier(0.4, 0.22, 0.28, 1);
  transition: box-shadow 100ms cubic-bezier(0.4, 0.22, 0.28, 1);
...
.Polaris-RangeSlider-SingleThumb__Input::-webkit-slider-thumb {
  ...
  -webkit-appearance: none;
  appearance: none;
  -webkit-transition: box-shadow 100ms cubic-bezier(0.4, 0.22, 0.28, 1);
  transition: box-shadow 100ms cubic-bezier(0.4, 0.22, 0.28, 1);
...
.Polaris-RangeSlider-SingleThumb__Input::-ms-thumb {
  margin-top: 0;
  transform: translateY(0.32rem) scale(0.4);
}
...
.Polaris-RangeSlider-SingleThumb--error .Polaris-RangeSlider-SingleThumb__Input {
  --progress-lower: rgba(216, 44, 13, 1);
}
...
.Polaris-RangeSlider-SingleThumb__Output {
  ...
  transform: translateX(calc(-50% + var(--Polaris-RangeSlider-output-factor) * 1.6rem));
  opacity: 0;
  visibility: hidden;
  pointer-events: none;
...
.Polaris-RangeSlider-DualThumb__Thumbs {
  ...
  -webkit-tap-highlight-color: transparent;
  cursor: -webkit-grab;
  transition: transform 150ms cubic-bezier(0.4, 0.22, 0.28, 1);
}
...
.Polaris-RangeSlider-DualThumb--error .Polaris-RangeSlider-DualThumb__Thumbs {
  border-color: #d82c0d;
  background: linear-gradient(#d82c0d, #d82c0d);
}
