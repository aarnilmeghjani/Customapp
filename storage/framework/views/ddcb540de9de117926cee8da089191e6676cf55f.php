...
<html lang="en">
    ...
    <body>
        ...
        <?php if(\Osiset\ShopifyApp\Util::getShopifyConfig('appbridge_enabled')): ?>
            ...
            <script src="https://unpkg.com/@shopify/app-bridge-utils<?php echo e(\Osiset\ShopifyApp\Util::getShopifyConfig('appbridge_version') ? '@'.config('shopify-app.appbridge_version') : ''); ?>"></script>
            <script
...
<?php /**PATH /home/krunal-planetx/Work/Web/larave-vue-app/custom-app/vendor/osiset/laravel-shopify/src/resources/views/layouts/default.blade.php ENDPATH**/ ?>