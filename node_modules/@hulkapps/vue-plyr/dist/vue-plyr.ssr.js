...
});var RangeError = global_1$1.RangeError; // `String.prototype.repeat` method implementation
...
var createMethod$7 = function (CONVERT_TO_STRING) {
  return function ($this, pos) {
    ...
    return first < 0xD800 || first > 0xDBFF || position + 1 === size || (second = charCodeAt$1(S, position + 1)) < 0xDC00 || second > 0xDFFF ? CONVERT_TO_STRING ? charAt$2(S, position) : first : CONVERT_TO_STRING ? stringSlice$4(S, position, position + 2) : (first - 0xD800 << 10) + (second - 0xDC00) + 0x10000;
  };
};
...
var stringPunycodeToAscii = function (input) {
  var encoded = [];
  var labels = split$2(replace$4(toLowerCase(input), regexSeparators, '\u002E'), '.');
  var i, label;
...
/* init */
{
  ...
  if (init !== undefined) {
    if (isObject$1(init)) {
      ...
      parseSearchParams(entries, typeof init == 'string' ? charAt$6(init, 0) === '?' ? stringSlice$9(init, 1) : init : toString_1(init));
    }
  }
};
...
var startsWithWindowsDriveLetter = function (string) {
  var third;
  return string.length > 1 && isWindowsDriveLetter(stringSlice$a(string, 0, 2)) && (string.length == 2 || (third = charAt$7(string, 2)) === '/' || third === '\\' || third === '?' || third === '#');
};
  ...
  objectDefineProperties$1(URLPrototype, {
    ...
    search: accessorDescriptor(getSearch, function (search) {
      ...
      if (search == '') {
        ...
        if ('?' == charAt$7(search, 0)) search = stringSlice$a(search, 1);
        url.query = '';
    ...
    hash: accessorDescriptor(getHash, function (hash) {
      ...
      if ('#' == charAt$7(hash, 0)) hash = stringSlice$a(hash, 1);
      url.fragment = '';
...
if (FORCED$5) {
  ...
  var keys$4 = getOwnPropertyNames$2(NativeRegExp$1);
  var index$1 = 0;
...
var collectionStrong = {
  getConstructor: function (wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
    ...
    if (descriptors) defineProperty$c(C.prototype, 'size', {
      get: function () {
...
}, collectionStrong);var FAILS_ON_PRIMITIVES$5 = fails(function () {
